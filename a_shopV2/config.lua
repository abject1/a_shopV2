Config = {
    ...
    Locations = {
        ...
        [3] = {
            ["shelfs"] = {
				...
				{["x"] = -1226.32, ["y"] = -907.43, ["z"] = 12.32, ["value"] = "drinks"},
				{["x"] = -1222.17, ["y"] = -903.63, ["z"] = 12.32, ["value"] = "snacks"},
        ...
        [4] = {
            ["shelfs"] = {
				...
				{["x"] = -1486.46, ["y"] = -382.69, ["z"] = 40.16, ["value"] = "drinks"},
				{["x"] = -1490.90, ["y"] = -379.67, ["z"] = 40.16, ["value"] = "snacks"},
        ...
        [6] = {
            ["shelfs"] = {
				...
				{["x"] = 1136.86, ["y"] = -978.87, ["z"] = 46.42, ["value"] = "drinks"},
				{["x"] = 1138.76, ["y"] = -984.30, ["z"] = 46.42, ["value"] = "snacks"},
       ...
       --     ["cashier"] = {
        ...
        [12] = {
            ["shelfs"] = {
				...
				{["x"] = -2969.76, ["y"] = 387.86, ["z"] = 15.04, ["value"] = "drinks"},
                {["x"] = -2970.31, ["y"] = 393.54, ["z"] = 15.04, ["value"] = "snacks"},
        ...
        [15] = {
            ["shelfs"] = {
				...
				{["x"] = 1169.17, ["y"] = 2707.64, ["z"] = 38.16, ["value"] = "drinks"},
                {["x"] = 1163.49, ["y"] = 2706.67, ["z"] = 38.16, ["value"] = "snacks"},
        ...
        [18] = {
            ["shelfs"] = {
				...
				{["x"] = 1398.90, ["y"] = 3605.51, ["z"] = 34.98, ["value"] = "drinks"},
                {["x"] = 1395.84, ["y"] = 3603.89, ["z"] = 34.98, ["value"] = "snacks"},
    ...
    Locales = {
        ["checkout"] = "Payer son panier",
        ["drinks"] = "Boissons",
        ["snacks"] = "Snacks",
        ["readymeal"] = "Nourriture",
        ["diverse"] = "Autres...",
    },

    Items = {
        ["drinks"] = {
            {label = "Coca Cola", item = "cocacola", price = 15},
            {label = "Fanta Exotic", item = "fanta", price = 15},
            {label = "Sprite", item = "sprunk", price = 15},
            {label = "Loka Crush", item = "loka", price = 15},
			{label = "Café", item = "coffe", price = 15},
            {label = "DR pepper", item = "drpepper", price = 15},
            {label = "Ice Tea", item = "icetea", price = 15},
            {label = "Heinken", item = "beer", price = 15},
            {label = "Vodka", item = "vodka", price = 50},
            {label = "Wisky", item = "whisky", price = 15},
            {label = "Sprite", item = "sprite", price = 15},
            {label = "fanta", item = "Fanta", price = 15},
            
        },
        ["snacks"] = {
            {label = "Feuilletés au fromage", item = "cheesebows", price = 15},
            {label = "Chips", item = "chips", price = 15},
			{label = "Chocolat", item = "chocolate", price = 10},
			{label = "Cupcake", item = "cupcake", price = 10},
            {label = "Oréo", item = "oreo", price = 10},
            
        },
        ["readymeal"] = {
            {label = "Kebab Pizza", item = "pizza", price = 30},
            {label = "Bacon Burgare", item = "burger", price = 30},
            {label = "Pasta Carbonara", item = "pastacarbonara", price = 30},
			{label = "Sandwich", item = "sandwich", price = 30},
            {label = "Hamburger", item = "hamburger", price = 25},
            {label = "Pizza", item = "pizza", price = 19},
            {label = "Pasta Box", item = "whisky", price = 20},
        },
        ["diverse"] = {
            {label = "Briquet", item = "lighter", price = 10},
            {label = "Cigarette", item = "cigarett", price = 25},
			{label = "Lottery", item = "scratchoff", price = 200},
			{label = "Nitro", item = "nitrocannister", price = 6500},
			{label = "Clé a molette", item = "wrench", price = 450},
            {label = "Pèse de détail", item = "drugscales", price = 80},
            {label = "Bandage", item = "bandage", price = 210},
